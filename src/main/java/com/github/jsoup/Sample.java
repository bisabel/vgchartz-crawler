...
public class Sample {
    ...
    public static void main(String[] args)  throws Exception{
        ...
        String platform = "https://www.vgchartz.com/platform/7/xbox-360/";
        Document _doc = Jsoup.parse(new URL(platform).openStream(), "ISO-8859-1", platform);
        ...
        String url = "https://www.vgchartz.com/game/180525/fifa-18";
        //String url = "https://www.vgchartz.com/game/120133/marvels-spider-man";
        //String url = "https://www.vgchartz.com/game/83196/grand-theft-auto-v";
        try {
          Sample.gamePage(url);
        } catch (Exception e){
          System.out.println( "Exception catch: "+url );
        }
    ...
    public static void gamePage(String url) throws Exception{
